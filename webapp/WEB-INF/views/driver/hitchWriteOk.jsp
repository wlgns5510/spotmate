...
<div class="inner">
	...
	<div class="mid">
		...
		<input type="hidden" name="type" value="hitchhike">
			...
			<div class="f-sec">
				<span>출발 날짜</span><input type="text" name="sdate1" value="${dwv.sdate1}" id="hitch-s-date""><br>
				<span>출발 시간</span><input type="text" name="stime1" value="${dwv.stime1}" id="hitch-s-time">
			</div>
			<div class="s-sec">
				<p>드라이버님의 이동 경로입니다</p>
