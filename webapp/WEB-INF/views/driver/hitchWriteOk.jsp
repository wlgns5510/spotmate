...
<div class="inner">
	...
	<div class="mid">
		...
		<input type="hidden" name="type" value="2">
			...
			<div class="f-sec">
				<span>출발 날짜</span><input type="text" style="width:550px;" name="sdate" value="${dwv.sdate}" id="s-date" readonly><br>
				<span>출발 시간</span><input type="text" style="width:550px;" name="stime" value="${dwv.stime}" id="s-time" readonly>
