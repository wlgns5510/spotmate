			...
			<section class="myPage_selection">
				...
				<article class="myPage_article2">
					<form method="post"
						...
						<div class="myQnaryeo">
							...
							<table>
								...
								<tr>
									...
									<td><input class="myqnainput" id="qnatitle" name="title"
										placeholder="&nbsp;제목을 작성해주세요" type="text"></td>
								</tr>
								<tr>
									<td><span>내용*</span></td>
						...
						<input type="submit" id="myqnanext" placeholder="등록하기"
							class="DForm_enrollbtn0">
					</form>
				</article>
			</section>
		</main>
