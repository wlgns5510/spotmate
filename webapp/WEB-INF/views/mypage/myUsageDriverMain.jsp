		...
		<main class="contents">
			...
			<section class="myPage_selection">
				...
				<div class="topnav">
					...
					<ul>
						<li><a class="active" href="/myUsageDriverMain/1">DRIVER 이용내역</a></li>
					</ul>
					<ul>
						<li><a href="/myUsageUserMain/1">USER 이용내역</a></li>
					</ul>
				</div>
...
document.getElementById("endDate").value = new Date(new Date().getTime() - (new Date().getTimezoneOffset() * 60000)).toISOString().slice(0, 10);
 ...
 function msg() {
	 window.open("review", "child", "width=1350, height=820, left=300, top=100");
 }
